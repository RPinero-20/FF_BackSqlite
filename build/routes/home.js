...
const buyListConfirm_c_1 = require("../controller/buyListConfirm_c");
...
clientRouter.put(lastConfirmation, buyListConfirm_c_1.putOrderConfirmed);
clientRouter.get(paymentDetail, buyListConfirm_c_1.getPaymentDetail);
