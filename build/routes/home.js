...
clientRouter.get(homeUrl, [middlewares_1.authJwtStore.verifyToken], home_1.getProducts);
clientRouter.get(userAuthInfo, clientAcces_1.userAuthGuest);
clientRouter.post(signUp, [middlewares_1.authJwtStore.verifyToken], clientAcces_1.clientSignUp);
...
clientRouter.get(productsList, [middlewares_1.authJwtStore.verifyToken], productsList_1.getFnToFind);
clientRouter.get(productDetail, [middlewares_1.authJwtStore.verifyToken], productDetail_1.getProductDetail);
clientRouter.post(payresume, [middlewares_1.authJwtStore.verifyToken], payresume_1.getPayResume);
clientRouter.put(payresume, [middlewares_1.authJwtStore.verifyToken], payresume_1.getPayResume);
