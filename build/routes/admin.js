...
adminRouter.post(createCategory, admin_2.postCategory);
adminRouter.put(editedCategory, admin_1.putCategory);
adminRouter.delete(delCategory, admin_1.deleteCategory);
